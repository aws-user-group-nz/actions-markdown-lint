...
![Deploy Status](https://github.com/aws-user-group-nz/actions-markdown-lint/actions/workflows/tag-and-release.yml/badge.svg)

![GitHub release](https://img.shields.io/github/v/release/aws-user-group-nz/actions-markdown-lint)
...
2. **Specific Version**:
   ...
   ```yaml
   uses: aws-user-group-nz/actions-markdown-lint/.github/workflows/markdown-lint.yml@v1.0.1
   ```
